										...
										<div class="grid__item skill-item">
											...
											<ul class="list-unstyled skill-list">
												<li class="skill-list-item">
													<h1>Modèle:</h1>
													<p class="skill-description"><?php echo $fetch_puff['Modèle']; ?>
													</p>
												</li>
												<li class="skill-list-item">
													<h1>Année:</h1>
													<p class="skill-description"><?php echo $fetch_puff['Année']; ?></p>
												</li>
												<li class="skill-list-item">
													<h1>Moteur:</h1>
													<p class="skill-description"><?php echo $fetch_puff['moteur']; ?>
													</p>
												</li>
											</ul>
										</div>
